...
export default function Signup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Account created! Welcome to Kinetic.')
      navigate('/dashboard')
    } catch (err: any) {
          ...
          <div className={styles.illustration}>
            <div className={styles.illustrationInner}>
              <div className={styles.illustrationOverlay}>
                <h1 className={styles.illustrationTitle}>Begin Your Journey.</h1>
                <p style={{ color: 'var(--color-on-surface-variant)', maxWidth: 380, fontSize: 15 }}>
                  Join 50,000+ developers and typists who track their speed and crush their personal bests.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className={styles.cardWrap}>
            <div className={`glass-card ${styles.card}`}>
              <div className={styles.cardHeader}>
                ...
                <p style={{ color: 'var(--color-on-surface-variant)', fontSize: 15 }}>Start your typing journey for free.</p>
              </div>
